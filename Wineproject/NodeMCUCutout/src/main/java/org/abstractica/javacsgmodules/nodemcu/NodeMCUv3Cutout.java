...
public class NodeMCUv3Cutout {

    private double x = 33.5;
    private double y = 58.4;
    private double z = 6.0;

    private double holeSize = 2.6;
    private double holeXDistance = 25.0;

    private double holeYDistance = 51.5;
    private double pinlength = 38.4;
    private double pinwidth = 3.0;
    private double pinheight = 10.0;
    private double pinXDist = 30.5;
